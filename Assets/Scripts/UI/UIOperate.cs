...
public class UIOperate : MonoBehaviour
{
    ...
    private void RefreshBodyInfo()
    {
        ...
        {
            // Normal whenever the headset is off the head: the proximity sensor gates tracking.
        ...
        // frame spends width on a constant. Calibration and confidence are the two that move, and
        // calibration is the one worth waiting for before trusting joint scale.
