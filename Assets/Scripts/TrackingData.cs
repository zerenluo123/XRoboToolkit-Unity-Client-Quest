...
namespace Robot
{
    public class TrackingData
    {
        ...
        private void GetBodyMetaJsonData()
        {
            ...
            // Data-quality metadata. Consumers should gate on these: while calib is Calibrating the
            // skeleton scale is still being estimated, and fidelity Low means IK-only inference
            // rather than camera-measured IOBT.
